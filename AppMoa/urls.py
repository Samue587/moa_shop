...
urlpatterns = [
    ...
    path(
        "carrito/actualizar/<int:variacion_id>/",
        views.carrito_actualizar,
        name="carrito_actualizar",
    ),
    path(
        "carrito/remover/<int:variacion_id>/",
        views.carrito_remover,
        name="carrito_remover",
    ),
    ...
    path( 
        ...
        "checkout/comprobante/<int:venta_id>/",
        views.checkout_comprobante,
        name="checkout_comprobante",
    ...
    path(
        "admin/permisos/editar/<int:id>/", views.editar_permiso, name="editar_permiso"
    ),
    path(
        "admin/permisos/eliminar/<int:id>/",
    ...
    path(
        "admin/usuarios/editar/<int:id>/", views.editar_usuario, name="editar_usuario"
    ),
    path(
        "admin/usuarios/eliminar/<int:id>/",
    ...
    path(
        "admin/proveedores/editar/<int:id>/",
        views.editar_proveedor,
        name="editar_proveedor",
    ),
    path(
        "admin/proveedores/eliminar/<int:id>/",
    ...
    path(
        "admin/catalogos/editar/<int:id>/",
        views.editar_catalogo,
        name="editar_catalogo",
    ),
    path(
        "admin/catalogos/eliminar/<int:id>/",
        views.eliminar_catalogo,
        name="eliminar_catalogo",
    ),
    # ══════════════════════════════════════════════════════
    # ADMIN — CATEGORÍAS
    # ══════════════════════════════════════════════════════
    ...
    path(
        "admin/categorias/editar/<int:id>/",
        views.editar_categoria,
        name="editar_categoria",
    ),
    path(
        "admin/categorias/eliminar/<int:id>/",
    ...
    path(
        "admin/productos/editar/<int:id>/",
        views.editar_producto,
        name="editar_producto",
    ),
    path(
        "admin/productos/eliminar/<int:id>/",
    ...
    # ══════════════════════════════════════════════════════
    path(
        "admin/productos/<int:producto_id>/variaciones/",
        views.listar_variaciones,
        name="admin_variaciones",
    ),
    path(
        "admin/productos/<int:producto_id>/variaciones/crear/",
        views.crear_variacion,
        name="crear_variacion",
    ),
    path(
        "admin/productos/<int:producto_id>/variaciones/editar/<int:id>/",
        views.editar_variacion,
        name="editar_variacion",
    ),
    path(
        "admin/productos/<int:producto_id>/variaciones/eliminar/<int:id>/",
        views.eliminar_variacion,
        name="eliminar_variacion",
    ),
    # ══════════════════════════════════════════════════════
    ...
    path(
        "admin/inventario/detalle/<int:id>/",
        views.detalle_entrada,
        name="detalle_entrada",
    ),
    path(
        "admin/inventario/eliminar/<int:id>/",
    ...
    path(
        "admin/envios/eliminar/<int:id>/", views.eliminar_envio, name="eliminar_envio"
    ),
    path(
        "admin/envios/estado/<int:id>/",
        views.envio_cambiar_estado,
        name="envio_cambiar_estado",
    ),
    # ══════════════════════════════════════════════════════
    ...
    path(
        "admin/reportes/categorias/",
        views.reporte_categorias,
    ...
    # ══════════════════════════════════════════════════════
    path(
        "admin/exportar/clientes/excel/",
        views.exportar_clientes_excel,
        name="exportar_clientes_excel",
    ),
    path(
        "admin/exportar/clientes/pdf/",
        views.exportar_clientes_pdf,
        name="exportar_clientes_pdf",
    ),
    path(
        "admin/exportar/envios/excel/",
        views.exportar_envios_excel,
        name="exportar_envios_excel",
    ),
    path(
        "admin/exportar/envios/pdf/",
        views.exportar_envios_pdf,
        name="exportar_envios_pdf",
    ),
    path(
        "admin/exportar/inventario/excel/",
        views.exportar_inventario_excel,
        name="exportar_inventario_excel",
    ),
    path(
        "admin/exportar/inventario/pdf/",
        views.exportar_inventario_pdf,
        name="exportar_inventario_pdf",
    ),
    path(
        "admin/exportar/categorias/excel/",
        views.exportar_categorias_excel,
        name="exportar_categorias_excel",
    ),
    path(
        "admin/exportar/categorias/pdf/",
